...
var process, global, Meteor;

(function(){

/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                 //
// packages/meteor/import_process.js                                                                               //
//                                                                                                                 //
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                   //
if (Package["meteor-env-dev"]) {                                                                                   // 1
  process = Package["meteor-env-dev"].process;                                                                     // 2
} else if (Package["meteor-env-prod"]) {                                                                           // 3
  process = Package["meteor-env-prod"].process;                                                                    // 4
}                                                                                                                  // 5
                                                                                                                   // 6
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                   //
var nodeEnv = process.env.NODE_ENV;                                                                                // 1
                                                                                                                   // 2
Meteor = {                                                                                                         // 3
  isProduction: nodeEnv === "production",                                                                          // 4
  isDevelopment: nodeEnv === "development",                                                                        // 5
  isClient: false,                                                                                                 // 6
  isServer: true,                                                                                                  // 7
  isCordova: false                                                                                                 // 8
};                                                                                                                 // 9
...
Meteor.settings = {};                                                                                              // 11
                                                                                                                   // 12
if (process.env.METEOR_SETTINGS) {                                                                                 // 13
  try {                                                                                                            // 14
    Meteor.settings = JSON.parse(process.env.METEOR_SETTINGS);                                                     // 15
  } catch (e) {                                                                                                    // 16
    throw new Error("METEOR_SETTINGS are not valid JSON: " + process.env.METEOR_SETTINGS);                         // 17
  }                                                                                                                // 18
}                                                                                                                  // 19
                                                                                                                   // 20
// Make sure that there is always a public attribute                                                               // 21
// to enable Meteor.settings.public on client                                                                      // 22
if (! Meteor.settings.public) {                                                                                    // 23
    Meteor.settings.public = {};                                                                                   // 24
}                                                                                                                  // 25
                                                                                                                   // 26
// Push a subset of settings to the client.  Note that the way this                                                // 27
// code is written, if the app mutates `Meteor.settings.public` on the                                             // 28
// server, it also mutates                                                                                         // 29
// `__meteor_runtime_config__.PUBLIC_SETTINGS`, and the modified                                                   // 30
// settings will be sent to the client.                                                                            // 31
if (typeof __meteor_runtime_config__ === "object") {                                                               // 32
  __meteor_runtime_config__.PUBLIC_SETTINGS = Meteor.settings.public;                                              // 33
}                                                                                                                  // 34
                                                                                                                   // 35
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
