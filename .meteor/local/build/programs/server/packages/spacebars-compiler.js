...
var SpacebarsCompiler, TemplateTag, ReactComponentSiblingForbidder, coffee;
...
TemplateTag.parse = function (scannerOrString) {                                                             // 88
  ...
  var scanArgValue = function () {                                                                           // 213
    ...
    if ((result = BlazeTools.parseNumber(scanner))) {                                                        // 216
      ...
      expected('identifier, number, string, boolean, null, or a sub expression enclosed in "(", ")"');       // 235
    }                                                                                                        // 236
  };                                                                                                         // 237
                                                                                                             // 238
...
SpacebarsCompiler._beautify = function (code) {                                                              // 97
  if (Package['minifiers-js'] && Package['minifiers-js'].UglifyJSMinify) {                                   // 98
    var result = Package['minifiers-js'].UglifyJSMinify(                                                     // 99
      code,                                                                                                  // 100
      { fromString: true,                                                                                    // 101
        mangle: false,                                                                                       // 102
        compress: false,                                                                                     // 103
