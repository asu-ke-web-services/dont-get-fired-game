...
var testSubtree = function (value, pattern) {                                                                        // 143
  ...
  for (var i = 0; i < typeofChecks.length; ++i) {                                                                    // 150
    if (pattern === typeofChecks[i][0]) {                                                                            // 151
      if (typeof value === typeofChecks[i][1])                                                                       // 152
        return false;                                                                                                // 153
      return {                                                                                                       // 154
        message: "Expected " + typeofChecks[i][1] + ", got " + (value === null ? "null" : typeof value),             // 155
        path: ""                                                                                                     // 156
      };                                                                                                             // 157
    }                                                                                                                // 158
  }                                                                                                                  // 159
  ...
  if (pattern === Match.Integer) {                                                                                   // 180
    ...
    if (typeof value === "number" && (value | 0) === value)                                                          // 187
      return false;                                                                                                  // 188
    return {                                                                                                         // 189
      message: "Expected Integer, got " + (value instanceof Object ? EJSON.stringify(value) : value),                // 190
      path: ""                                                                                                       // 191
    };                                                                                                               // 192
  }                                                                                                                  // 193
                                                                                                                     // 194
